...
public class BasicPlayer implements BasicController, Runnable
{
    ...
    private static Log log1 = LogFactory.getLog(BasicPlayer.class);
    private static Log log2 = new NoOpLog();
    private static Log log = log1;
    /**
...
//					m_line.flush();
    ...
    /**
     * enables or disables Logging messages for BasicPlayers
     * @param enable
     */
